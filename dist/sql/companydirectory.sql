...
-- Dumping structure for table company_directory.department
...
-- Dumping data for table company_directory.department: ~12 rows (approximately)
...
-- Dumping structure for table company_directory.location
...
-- Dumping data for table company_directory.location: ~4 rows (approximately)
...
-- Dumping structure for table company_directory.personnel
...
-- Dumping data for table company_directory.personnel: ~100 rows (approximately)
